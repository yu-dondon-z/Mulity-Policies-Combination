   ...
   # range to contain the real joint armature 
    ...
    class rewards:
        class scales:
            ...
            action_rate = -0.0005
            stand_still = -1.0
            default_pos =-0.01####-0.04
            default_hip_pos = -1.2
            feet_contact_forces=-0.001#-0.01
            jump=6.0
            trot=0.0
            feet_clearance=1.0#5.0
            horizontal_force = 0.0

        only_positive_rewards = False # if true negative total rewards are clipped at zero (avoids early termination problems)
        tracking_sigma = 0.30 # tracking reward = exp(-error^2/sigma)
        soft_dof_pos_limit = 0.9 # percentage of urdf limits, values above this limit are penalized
        soft_dof_vel_limit = 1.
        soft_torque_limit = 1.
        base_height_target = 0.40#0.25
...
class GO2_TrottoJump_PPO(LeggedRobotCfgPPO):
    ...
    class runner:
        ...
        experiment_name = 'go2_trottojump2'
        run_name = ''
        # load and resume
        resume = False
